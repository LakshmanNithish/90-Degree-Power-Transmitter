# 90° Mechanical Power Transmission
...
The complete assembly was modeled, constrained, and animated in SolidWorks to verify the motion.

---

## Features

- 3D CAD model created in SolidWorks
- Complete assembly with proper mates
- 90° power transmission mechanism
- Motion simulation using SolidWorks Motion Study
...
🎥 [Watch the Demo](90 degree power transmission.mp4)
...
- Add stress analysis
- Perform motion analysis with torque
- Optimize the design
- Manufacture a physical prototype
- Compare with bevel gear and universal joint mechanisms
